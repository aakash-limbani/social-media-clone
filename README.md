...
<h3 align="center"><a href="https://aakash-limbani-social-media-clone.vercel.app/"><strong>Want to see live preview »</strong></a></h3>

<p align="center"> 
    <br />&#10023;
    <a href="#Demo">View Demo</a>   &#10023;  
    <a href="https://github.com/aakash-limbani/social-media-clone/issues">Report Bug</a>    &#10023;
...
The project repository can be found in [GitHub link](https://github.com/aakash-limbani/social-media-clone) or just clone the project using this command. 


```
Using HTTPS

# git clone  https://github.com/aakash-limbani/social-media-clone.git
```

+ Open terminal on your workspace with

```
cd /home/workspace/social-media-clone
```
